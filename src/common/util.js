export const leadToCorrectLoginUserPage = (currentUser, history) => {
...
export const getContactReport= (json, isOne) => {
    console.log(json)
...
export const getJobApplicantsReport = (json, isOne) => {
    console.log(json)
...
export const getUsersRegistrationReport = (json, isOne) => {
    console.log(json)
